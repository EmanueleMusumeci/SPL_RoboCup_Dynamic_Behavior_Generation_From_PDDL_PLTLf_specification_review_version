...
def setup_experiment():
    ...
    def striker_has_reached_waypoint_1(striker_position, waypoint_distance_threshold, is_next_waypoint_1):
        reached_1 = distance(striker_position, ValueRegistry()["waypoint1"]) < waypoint_distance_threshold
        if reached_1:
    ...
    def striker_has_reached_waypoint_2(striker_position, waypoint_distance_threshold, is_next_waypoint_2):
        reached_2 = distance(striker_position, ValueRegistry()["waypoint2"]) < waypoint_distance_threshold
        if reached_2:
