...
from lib.benchmarks import generate_adjacency_reticle_string, benchmark_conditioned_FOND_policy_over_generated_problems_with_fixed_constraints, get_goal_scored_condition, get_initial_robot_ball_position, get_waypoints_matrix, plot
...
def get_base_problem_name():
    return "striker_with_waypoint_conditioning"
