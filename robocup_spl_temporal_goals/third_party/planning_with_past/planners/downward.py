...
class DownwardPlanner(Planner):
    ...
    def plan(self, domain_path: Path, problem_path: Path, **options: Dict[str, str]) -> Plan:
        """
        ...
        :return: the plan.
        """
        orig_domain_path = domain_path.absolute()
        orig_problem_path = problem_path.absolute()
