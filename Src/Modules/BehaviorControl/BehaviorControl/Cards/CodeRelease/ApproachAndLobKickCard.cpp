...
class ApproachAndLobKickCard : public ApproachAndLobKickCardBase
{
    ...
    state(kick)
    {
      ...
      action
      {
        theLookAtPointSkill(Vector3f(theFieldBall.positionRelative.x(),
                                     theFieldBall.positionRelative.y(),
                                       0.f));
        theKickSkill(false, 9000.f, false);
      }
    }
...
MAKE_CARD(ApproachAndLobKickCard);
